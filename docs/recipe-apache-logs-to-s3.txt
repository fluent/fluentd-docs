# Getting Data From Apache Logs Into S3 Using Fluentd

Looking to get data out of apache logs into s3? You can do that with [fluentd](//fluentd.org) in **10 minutes**!
